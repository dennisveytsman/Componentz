...
I now understand software development better because I now realize what it is like to build off of existing things to create a new component. I also understand that I do not know much about software development at all, so I will look into it more over the summer.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

Yes, the gaps in my knowledge were about many things, including not knowing what a record and an abstract class were, and I addressed them by going to help nights and researching online.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

It has become a bit more fun for me now, since I had the freedom to choose what I wanted to have as a component and I enjoyed constructing it. I cannot say I fully enjoy software development right now due to my current lack of skill, but I will try to improve at projects such as this one over time.
...
I learned a bit more about object-oriented design and learned how to abstract a component onto an already existing one.
...
I am still unsure about CSE, and I maybe should have looked at chemical engineering or material science a bit closer before deciding CSE as my major. But for my future career trajectory, I am now more interested in programming and what I can accomplish with it. Although I still don't know what I plan to go into(cybersecurity, AI, data analytics, etc.)
...
To continue on my career trajectory, I could explore all of my career options in CSE and see what I enjoy doing the most. I don't know what mentors I could contact to help stay on my path. I guess I do know a couple upperclassmen who are majoring in CSE or similar majors.
