...
A representation would be List<Bird>, since I can add and remove birds without worrying about a fixed size of an array. I also iterate through the birds, and List is iterable.
